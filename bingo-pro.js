...
const bingo = () => {
  PlayerName =
    prompt("Welcome to ISDI Coders Bingo, dear user. What's your name?");
  let instructions = confirm(`Dear ${PlayerName} , you have to complete your cardboard the less turns the better. You have 90 points now and you will lose 1 each turn. Do you want to want to play? `);
